...
public class studentform extends Activity implements B4AActivity{
	public static studentform mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.studentform");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (studentform).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.studentform");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.studentform", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (studentform) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (studentform) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (studentform) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (studentform) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
if (_firsttime) { 
 //BA.debugLineNum = 24;BA.debugLine="copydbifneeded(\"database.db\")";
_copydbifneeded("database.db");
 //BA.debugLineNum = 25;BA.debugLine="sql.Initialize(File.DirInternal,\"database.db\",Fa";
_sql.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"database.db",anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 28;BA.debugLine="drawer.Initialize(Me,\"\",Activity,60%x)";
mostCurrent._drawer._initialize /*String*/ (mostCurrent.activityBA,studentform.getObject(),"",(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA));
 //BA.debugLineNum = 29;BA.debugLine="drawer.CenterPanel.LoadLayout(\"studentform\")";
mostCurrent._drawer._getcenterpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().LoadLayout("studentform",mostCurrent.activityBA);
 //BA.debugLineNum = 30;BA.debugLine="drawer.Leftpanel.Loadlayout(\"laydrawer\")";
mostCurrent._drawer._getleftpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().LoadLayout("laydrawer",mostCurrent.activityBA);
 //BA.debugLineNum = 31;BA.debugLine="lblme.Text = Main.myfname&\" \"&Main.mylname";
mostCurrent._lblme.setText(BA.ObjectToCharSequence(mostCurrent._main._myfname /*String*/ +" "+mostCurrent._main._mylname /*String*/ ));
 //BA.debugLineNum = 32;BA.debugLine="B4XTable1.AddColumn(\"Student\",B4XTable1.COLUMN_TY";
mostCurrent._b4xtable1._addcolumn /*b4a.example.b4xtable._b4xtablecolumn*/ ("Student",mostCurrent._b4xtable1._column_type_text /*int*/ );
 //BA.debugLineNum = 33;BA.debugLine="B4XTable1.AddColumn(\"Teacher\",B4XTable1.COLUMN_TY";
mostCurrent._b4xtable1._addcolumn /*b4a.example.b4xtable._b4xtablecolumn*/ ("Teacher",mostCurrent._b4xtable1._column_type_text /*int*/ );
 //BA.debugLineNum = 34;BA.debugLine="B4XTable1.AddColumn(\"Grades\",B4XTable1.COLUMN_TYP";
mostCurrent._b4xtable1._addcolumn /*b4a.example.b4xtable._b4xtablecolumn*/ ("Grades",mostCurrent._b4xtable1._column_type_numbers /*int*/ );
 //BA.debugLineNum = 35;BA.debugLine="showgrades";
_showgrades();
...
public static String  _copydbifneeded(String _filename) throws Exception{
 //BA.debugLineNum = 49;BA.debugLine="Sub copydbifneeded(Filename As String)";
 //BA.debugLineNum = 50;BA.debugLine="If File.Exists(File.DirInternal,Filename) = False";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),_filename)==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 51;BA.debugLine="File.Copy(File.DirAssets,Filename,File.DirIntern";
...
mostCurrent._b4xtable1 = new b4a.example.b4xtable();
 //BA.debugLineNum = 17;BA.debugLine="Dim drawer As B4XDrawer";
mostCurrent._drawer = new b4a.example.b4xdrawer();
 //BA.debugLineNum = 18;BA.debugLine="Private lblme As Label";
...
public static String  _label2_click() throws Exception{
 //BA.debugLineNum = 55;BA.debugLine="Sub Label2_Click";
 //BA.debugLineNum = 56;BA.debugLine="drawer.LeftOpen = True";
...
public static String  _lblabout_click() throws Exception{
 //BA.debugLineNum = 96;BA.debugLine="Sub lblabout_Click";
 //BA.debugLineNum = 97;BA.debugLine="drawer.LeftOpen = False";
mostCurrent._drawer._setleftopen /*boolean*/ (anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 98;BA.debugLine="StartActivity(\"about\")";
...
public static String  _lblhome_click() throws Exception{
 //BA.debugLineNum = 92;BA.debugLine="Sub lblhome_Click";
 //BA.debugLineNum = 93;BA.debugLine="drawer.LeftOpen = False";
mostCurrent._drawer._setleftopen /*boolean*/ (anywheresoftware.b4a.keywords.Common.False);
...
int _msg = 0;
 //BA.debugLineNum = 83;BA.debugLine="Sub lbllogout_Click";
 //BA.debugLineNum = 84;BA.debugLine="Dim msg As Int";
_msg = 0;
 //BA.debugLineNum = 85;BA.debugLine="msg = Msgbox2(\"Do You Want To Logout?\",\"\",\"Yes\",\"";
...
public static String  _lblme_click() throws Exception{
 //BA.debugLineNum = 78;BA.debugLine="Sub lblme_Click";
 //BA.debugLineNum = 79;BA.debugLine="drawer.LeftOpen = False";
mostCurrent._drawer._setleftopen /*boolean*/ (anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 80;BA.debugLine="StartActivity(\"profile\")";
...
Object[] _row = null;
 //BA.debugLineNum = 59;BA.debugLine="Sub showgrades";
 //BA.debugLineNum = 60;BA.debugLine="Dim data As List";
_data = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 61;BA.debugLine="data.Initialize";
_data.Initialize();
 //BA.debugLineNum = 62;BA.debugLine="Dim qry As String";
_qry = "";
 //BA.debugLineNum = 63;BA.debugLine="qry = \"SELECT student,teacher,grades from tblteac";
_qry = "SELECT student,teacher,grades from tblteacherstud where student = ?";
 //BA.debugLineNum = 64;BA.debugLine="Dim rs As ResultSet = sql.ExecQuery2(qry, Array A";
...
while (_rs.NextRow()) {
 //BA.debugLineNum = 66;BA.debugLine="Dim row(3) As Object";
...
;
 //BA.debugLineNum = 68;BA.debugLine="row(0) = rs.getstring(\"student\")";
_row[(int) (0)] = (Object)(_rs.GetString("student"));
 //BA.debugLineNum = 69;BA.debugLine="row(1) = rs.getstring(\"teacher\")";
_row[(int) (1)] = (Object)(_rs.GetString("teacher"));
 //BA.debugLineNum = 70;BA.debugLine="row(2) = rs.getstring(\"grades\")";
_row[(int) (2)] = (Object)(_rs.GetString("grades"));
 //BA.debugLineNum = 72;BA.debugLine="data.add(row)";
_data.Add((Object)(_row));
 }
;
 //BA.debugLineNum = 74;BA.debugLine="rs.Close";
_rs.Close();
 //BA.debugLineNum = 75;BA.debugLine="B4XTable1.SetData(data)";
