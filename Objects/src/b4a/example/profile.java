...
public class profile extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.profile");
...
public anywheresoftware.b4a.objects.LabelWrapper _lblclss = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 27;BA.debugLine="drawer.Initialize(Me,\"\",Activity,60%x)";
mostCurrent._drawer._initialize /*String*/ (mostCurrent.activityBA,profile.getObject(),"",(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA));
 //BA.debugLineNum = 28;BA.debugLine="drawer.CenterPanel.LoadLayout(\"profile\")";
mostCurrent._drawer._getcenterpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().LoadLayout("profile",mostCurrent.activityBA);
 //BA.debugLineNum = 29;BA.debugLine="drawer.Leftpanel.Loadlayout(\"laydrawer\")";
mostCurrent._drawer._getleftpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().LoadLayout("laydrawer",mostCurrent.activityBA);
 //BA.debugLineNum = 30;BA.debugLine="lblme.Text = Main.myfname&\" \"&Main.mylname";
mostCurrent._lblme.setText(BA.ObjectToCharSequence(mostCurrent._main._myfname /*String*/ +" "+mostCurrent._main._mylname /*String*/ ));
 //BA.debugLineNum = 32;BA.debugLine="lblname.Text = Main.myfname&\" \"&Main.mylname";
mostCurrent._lblname.setText(BA.ObjectToCharSequence(mostCurrent._main._myfname /*String*/ +" "+mostCurrent._main._mylname /*String*/ ));
 //BA.debugLineNum = 33;BA.debugLine="If Main.mylevel = 1 Then";
if ((mostCurrent._main._mylevel /*String*/ ).equals(BA.NumberToString(1))) { 
 //BA.debugLineNum = 34;BA.debugLine="lblclss.Text = \"Admin\"";
mostCurrent._lblclss.setText(BA.ObjectToCharSequence("Admin"));
 }else if((mostCurrent._main._mylevel /*String*/ ).equals(BA.NumberToString(2))) { 
 //BA.debugLineNum = 36;BA.debugLine="lblclss.Text = \"Teacher\"";
mostCurrent._lblclss.setText(BA.ObjectToCharSequence("Teacher"));
 }else if((mostCurrent._main._mylevel /*String*/ ).equals(BA.NumberToString(3))) { 
 //BA.debugLineNum = 38;BA.debugLine="lblclss.Text = \"Student\"";
mostCurrent._lblclss.setText(BA.ObjectToCharSequence("Student"));
 }else {
 //BA.debugLineNum = 40;BA.debugLine="lblclss.Text = \"Your an alien\"";
mostCurrent._lblclss.setText(BA.ObjectToCharSequence("Your an alien"));
 };
 //BA.debugLineNum = 43;BA.debugLine="lblclass.Text = lblclss.Text & \" ID:\"";
mostCurrent._lblclass.setText(BA.ObjectToCharSequence(mostCurrent._lblclss.getText()+" ID:"));
 //BA.debugLineNum = 44;BA.debugLine="lblid.Text = Main.myid";
mostCurrent._lblid.setText(BA.ObjectToCharSequence(mostCurrent._main._myid /*int*/ ));
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 16;BA.debugLine="Private lblclass As Label";
mostCurrent._lblclass = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 17;BA.debugLine="Private lblid As Label";
mostCurrent._lblid = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Private lblclss As Label";
mostCurrent._lblclss = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Private lblname As Label";
mostCurrent._lblname = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Private drawer As B4XDrawer";
...
public static String  _label7_click() throws Exception{
 //BA.debugLineNum = 55;BA.debugLine="Sub Label7_Click";
...
public static String  _lblabout_click() throws Exception{
 //BA.debugLineNum = 86;BA.debugLine="Sub lblabout_Click";
 //BA.debugLineNum = 87;BA.debugLine="StartActivity(\"about\")";
...
public static String  _lblhome_click() throws Exception{
 //BA.debugLineNum = 73;BA.debugLine="Sub lblhome_Click";
 //BA.debugLineNum = 74;BA.debugLine="If Main.mylevel = 1 Then";
if ((mostCurrent._main._mylevel /*String*/ ).equals(BA.NumberToString(1))) { 
 //BA.debugLineNum = 75;BA.debugLine="StartActivity(\"adminform\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("adminform"));
 //BA.debugLineNum = 76;BA.debugLine="drawer.LeftOpen = False";
mostCurrent._drawer._setleftopen /*boolean*/ (anywheresoftware.b4a.keywords.Common.False);
 }else if((mostCurrent._main._mylevel /*String*/ ).equals(BA.NumberToString(2))) { 
 //BA.debugLineNum = 78;BA.debugLine="StartActivity(\"teacherform\")";
...
mostCurrent._drawer._setleftopen /*boolean*/ (anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 81;BA.debugLine="StartActivity(\"studentform\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("studentform"));
 //BA.debugLineNum = 82;BA.debugLine="drawer.LeftOpen = False";
mostCurrent._drawer._setleftopen /*boolean*/ (anywheresoftware.b4a.keywords.Common.False);
 };
...
int _msg = 0;
 //BA.debugLineNum = 64;BA.debugLine="Sub lbllogout_Click";
 //BA.debugLineNum = 65;BA.debugLine="Dim msg As Int";
_msg = 0;
 //BA.debugLineNum = 66;BA.debugLine="msg = Msgbox2(\"Do You Want To Logout?\",\"\",\"Yes\",\"";
...
public static String  _lblme_click() throws Exception{
 //BA.debugLineNum = 60;BA.debugLine="Sub lblme_Click";
 //BA.debugLineNum = 61;BA.debugLine="StartActivity(\"profile\")";
