...
public class about extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.about");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 23;BA.debugLine="drawer.Initialize(Me,\"\",Activity,60%x)";
mostCurrent._drawer._initialize /*String*/ (mostCurrent.activityBA,about.getObject(),"",(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA));
 //BA.debugLineNum = 24;BA.debugLine="drawer.CenterPanel.LoadLayout(\"about\")";
mostCurrent._drawer._getcenterpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().LoadLayout("about",mostCurrent.activityBA);
 //BA.debugLineNum = 25;BA.debugLine="drawer.Leftpanel.Loadlayout(\"laydrawer\")";
mostCurrent._drawer._getleftpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().LoadLayout("laydrawer",mostCurrent.activityBA);
 //BA.debugLineNum = 26;BA.debugLine="lblme.Text = Main.myfname&\" \"&Main.mylname";
...
mostCurrent._drawer = new b4a.example.b4xdrawer();
 //BA.debugLineNum = 16;BA.debugLine="Private lblme As Label";
...
public static String  _label2_click() throws Exception{
 //BA.debugLineNum = 39;BA.debugLine="Sub Label2_Click";
...
public static String  _lblabout_click() throws Exception{
 //BA.debugLineNum = 73;BA.debugLine="Sub lblabout_Click";
 //BA.debugLineNum = 74;BA.debugLine="drawer.LeftOpen = False";
...
public static String  _lblhome_click() throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Sub lblhome_Click";
 //BA.debugLineNum = 58;BA.debugLine="If Main.mylevel = 1 Then";
if ((mostCurrent._main._mylevel /*String*/ ).equals(BA.NumberToString(1))) { 
 //BA.debugLineNum = 59;BA.debugLine="drawer.LeftOpen = False";
mostCurrent._drawer._setleftopen /*boolean*/ (anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 60;BA.debugLine="StartActivity(\"adminform\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("adminform"));
 ...
 //BA.debugLineNum = 63;BA.debugLine="drawer.LeftOpen = False";
mostCurrent._drawer._setleftopen /*boolean*/ (anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 64;BA.debugLine="StartActivity(\"teacherform\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("teacherform"));
 }else {
 //BA.debugLineNum = 67;BA.debugLine="drawer.LeftOpen = False";
mostCurrent._drawer._setleftopen /*boolean*/ (anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 68;BA.debugLine="StartActivity(\"studentform\")";
...
int _msg = 0;
 //BA.debugLineNum = 48;BA.debugLine="Sub lbllogout_Click";
 //BA.debugLineNum = 49;BA.debugLine="Dim msg As Int";
_msg = 0;
 //BA.debugLineNum = 50;BA.debugLine="msg = Msgbox2(\"Do You Want To Logout?\",\"\",\"Yes\",\"";
_msg = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("Do You Want To Logout?"),BA.ObjectToCharSequence(""),"Yes","No","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA);
 //BA.debugLineNum = 51;BA.debugLine="If msg = DialogResponse.POSITIVE Then";
...
public static String  _lblme_click() throws Exception{
 //BA.debugLineNum = 44;BA.debugLine="Sub lblme_Click";
 //BA.debugLineNum = 45;BA.debugLine="StartActivity(\"profile\")";
